// ============================================
// PDF BUILDER — Pflege L1: Erste Schritte
...
(function () {
    ...
    function buildPflegeWarn() {
        return `<div class="pflege-warn">
            ...
            <p>Această lecție te pregătește <strong>LINGVISTIC</strong> — îți dă primele cuvinte de care ai nevoie să te înțelegi cu pacienta și familia ei. <strong>NU înlocuiește</strong> calificarea profesională (Pflegehelferin / Pflegefachkraft). Pentru îngrijire reală, urmează un curs autorizat de Pflege.</p>
        </div>`;
    }

    function buildCast() {
        return `<div class="cast-banner">
            <h4>👋 Cast „Annettes Deutschkurs" · Andreea pleacă spre prima ei zi de Pflege</h4>
            <div class="cast-grid">
    ...
    function buildTheory() {
        ...
        return `<h1 class="chapter new-section">📘 1. Teorie — Primii pași în germană</h1>` + t;
    }
    ...
    function buildExercises() {
        ...
        if (typeof ex1Data !== 'undefined') {
            html += `<div class="ex-block"><h3>Übung 1: Match — Salutări DE → Traducere RO</h3>
                <div class="instruction">Pentru fiecare salutare DE, scrii traducerea în RO.</div>
        ...
        if (typeof ex2Data !== 'undefined') html += fillInBlock('Übung 2: Salutarea potrivită pe momentul zilei', 'Alege salutarea potrivită pe momentul zilei.', ex2Data);
        if (typeof ex4Data !== 'undefined') html += fillInBlock('Übung 4: Politețe — Bitte, Danke, Entschuldigung în context', 'Alege cuvântul potrivit (Bitte / Danke / Entschuldigung sau variante).', ex4Data);
        if (typeof ex5Data !== 'undefined') html += fillInBlock('Übung 5: Dialog Gap-Fill — Andreea la sosire', 'Completează replicile lipsă din Dialog 1.', ex5Data);

        if (typeof ex3Data !== 'undefined') {
            html += `<div class="ex-block"><h3>Übung 3: Audio Dictat — Litere și cifre</h3>
                <div class="instruction">Ascultă litera/cifra și scrie ce auzi. (Audio disponibil online — PDF afișează doar răspunsurile pentru recap.)</div>
                <div class="rezolvare-banner">✓ Rezolvare</div>`;
        ...
        html += `<div class="ex-block"><h3>✍️ Übung 7: Schreiben — Prezentare scurtă</h3>
            <div class="instruction">Imaginează-ți că sosești pentru prima oară la pacient. Prezintă-te în 3-4 propoziții.</div>
            <p><strong>Verbe utile:</strong> sein (bin) · heißen (heiße) · kommen (komme)</p>
    ...
    function buildFlashcards() {
        ...
        let html = `<h1 class="chapter new-section">📇 4. Vocabular complet (Flashcards)</h1>
            <p style="margin-bottom:10px">Cele <strong>${count} carduri</strong> ale lecției grupate pe categorii: Salutări · Politețe · Alfabet · Cifre · Verbe cheie · Fraze salvatoare.</p>
